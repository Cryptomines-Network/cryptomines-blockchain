...
class Err(Enum):
    ...
    # ETH Errors
    INVALID_BLOCK_HASH = 128
    INVALID_PARENT_HASH = 129
    INVALID_PREV_RANDAO = 130
    INVALID_BLOCK_NUMBER = 131
    INVALID_EXTRA_DATA_SIZE = 132
    INVALID_WITHDRAWALS_COUNT = 133
    INVALID_WITHDRAWAL_INDEX = 134
    INVALID_WITHDRAWAL_VALIDATOR_INDEX = 135
    INVALID_WITHDRAWAL_ADDRESS = 136
    INVALID_WITHDRAWAL_AMOUNT = 137
    INVALID_EXECUTION_PAYLOAD_PRESENCE = 138

    EXECUTION_INVALID_PAYLOAD = 139
    EXECUTION_SYNCING = 140
    EXECUTION_ACCEPTED = 141
